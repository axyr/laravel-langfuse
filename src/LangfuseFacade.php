 ...
 * @method static \Axyr\Langfuse\Dto\DatasetRunWithItemsResponse|null getDatasetRun(string $datasetName, string $runName)
 * @method static \Axyr\Langfuse\Dto\DatasetRunListResponse|null listDatasetRuns(string $datasetName, ?int $page = null, ?int $limit = null)
 * @method static bool deleteDatasetRun(string $datasetName, string $runName)
 * @method static \Axyr\Langfuse\Dto\DatasetRunItemResponse|null createDatasetRunItem(\Axyr\Langfuse\Dto\CreateDatasetRunItemBody $body)
 * @method static \Axyr\Langfuse\Dto\DatasetRunItemListResponse|null listDatasetRunItems(string $datasetId, string $runName, ?int $page = null, ?int $limit = null)
