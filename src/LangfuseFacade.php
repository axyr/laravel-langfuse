 ...
 * @method static void score(\Axyr\Langfuse\Dto\ScoreBody $body, ?string $timestamp = null)
 ...
 * @method static \Axyr\Langfuse\Dto\ObservationResponse|null getObservation(string $observationId, ?string $fromStartTime = null, ?string $toStartTime = null, ?string $fields = null)
 ...
 * @method static \Axyr\Langfuse\Dto\ExperimentListResponse|null listExperiments(\Axyr\Langfuse\Dto\ExperimentQuery $query)
 * @method static \Axyr\Langfuse\Dto\ExperimentItemListResponse|null listExperimentItems(\Axyr\Langfuse\Dto\ExperimentItemQuery $query)
 * @method static \Axyr\Langfuse\Dto\ExperimentResponse|null getExperiment(string $experimentId, string $fromStartTime, ?string $toStartTime = null)
...
class LangfuseFacade extends Facade
{
    public static function fake(): LangfuseFake
    {
        $fake = new LangfuseFake(
            app(CurrentPromptRegistry::class),
            app(LangfuseConfig::class),
            app(TraceContextResolverInterface::class),
        );
